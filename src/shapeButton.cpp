...
// 自定义圆形背景和形状按钮的类
ShapeButton::ShapeButton(QWidget *parent):  QWidget(parent), isTriangle(true) {
...
void ShapeButton::toggleToStatus(QString status, bool send){
...
void ShapeButton::toggleButtonShape() {
...
void ShapeButton::updateButtonShape(bool withAction) {
    // 更新按钮的遮罩
...
void ShapeButton::receiveStatusUpdateMessage(const QString status){
