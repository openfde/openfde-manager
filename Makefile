#############################################################################
# Makefile for building: openfde-ui
# Generated by qmake (3.1) (Qt 5.12.12)
# Project:  openfde-ui.pro
# Template: app
# Command: /usr/lib/qt5/bin/qmake -o Makefile openfde-ui.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_DEPRECATED_WARNINGS -DQT_NO_DEBUG -DQT_WIDGETS_LIB -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_DBUS_LIB -DQT_CORE_LIB
CFLAGS        = -pipe -O2 -Wall -W -D_REENTRANT -fPIC $(DEFINES)
CXXFLAGS      = -pipe -O2 -Wall -W -D_REENTRANT -fPIC $(DEFINES)
INCPATH       = -I. -I. -isystem /usr/include/aarch64-linux-gnu/qt5 -isystem /usr/include/aarch64-linux-gnu/qt5/QtWidgets -isystem /usr/include/aarch64-linux-gnu/qt5/QtGui -isystem /usr/include/aarch64-linux-gnu/qt5/QtNetwork -isystem /usr/include/aarch64-linux-gnu/qt5/QtDBus -isystem /usr/include/aarch64-linux-gnu/qt5/QtCore -I. -I/usr/lib/aarch64-linux-gnu/qt5/mkspecs/linux-g++
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = openfde-ui1.0.0
DISTDIR = /home/warlice/openFDE-ui/.tmp/openfde-ui1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS) /usr/lib/aarch64-linux-gnu/libQt5Widgets.so /usr/lib/aarch64-linux-gnu/libQt5Gui.so /usr/lib/aarch64-linux-gnu/libQt5Network.so /usr/lib/aarch64-linux-gnu/libQt5DBus.so /usr/lib/aarch64-linux-gnu/libQt5Core.so /usr/lib/aarch64-linux-gnu/libGL.so -lpthread   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
Makefile: openfde-ui.pro /usr/lib/aarch64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/aarch64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/aarch64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/aarch64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/aarch64-linux-gnu/qt5/mkspecs/common/sanitize.conf \
		/usr/lib/aarch64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
		...
		openfde-ui.pro \
		openfde-ui.qrc
	$(QMAKE) -o Makefile openfde-ui.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents mainwindow.h shapeButton.h download.h installworker.h $(DISTDIR)/
...
compiler_rcc_make_all: qrc_openfde-ui.cpp
compiler_rcc_clean:
	-$(DEL_FILE) qrc_openfde-ui.cpp
qrc_openfde-ui.cpp: openfde-ui.qrc \
		/usr/lib/qt5/bin/rcc \
		images/close.png \
		images/openfde.png \
		images/settings.png \
		images/minimize.png
	/usr/lib/qt5/bin/rcc -name openfde-ui openfde-ui.qrc -o qrc_openfde-ui.cpp
...
compiler_moc_header_make_all: moc_mainwindow.cpp moc_shapeButton.cpp moc_download.cpp moc_installworker.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mainwindow.cpp moc_shapeButton.cpp moc_download.cpp moc_installworker.cpp
...
moc_installworker.cpp: installworker.h \
		dbus.h \
		moc_predefs.h \
		/usr/lib/qt5/bin/moc
	/usr/lib/qt5/bin/moc $(DEFINES) --include /home/warlice/openFDE-ui/moc_predefs.h -I/usr/lib/aarch64-linux-gnu/qt5/mkspecs/linux-g++ -I/home/warlice/openFDE-ui -I/home/warlice/openFDE-ui -I/usr/include/aarch64-linux-gnu/qt5 -I/usr/include/aarch64-linux-gnu/qt5/QtWidgets -I/usr/include/aarch64-linux-gnu/qt5/QtGui -I/usr/include/aarch64-linux-gnu/qt5/QtNetwork -I/usr/include/aarch64-linux-gnu/qt5/QtDBus -I/usr/include/aarch64-linux-gnu/qt5/QtCore -I/usr/include/c++/9 -I/usr/include/aarch64-linux-gnu/c++/9 -I/usr/include/c++/9/backward -I/usr/lib/gcc/aarch64-linux-gnu/9/include -I/usr/local/include -I/usr/include/aarch64-linux-gnu -I/usr/include installworker.h -o moc_installworker.cpp
...
moc_shapeButton.o: moc_shapeButton.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_shapeButton.o moc_shapeButton.cpp

moc_download.o: moc_download.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_download.o moc_download.cpp

moc_installworker.o: moc_installworker.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_installworker.o moc_installworker.cpp
